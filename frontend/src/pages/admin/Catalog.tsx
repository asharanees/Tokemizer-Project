        ...
        <Layout>
            <div className="space-y-6">
                <div className="flex justify-between items-center">
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight">Plan Catalog</h1>
                        <p className="text-muted-foreground">Browse and manage subscription plans available to customers.</p>
                    </div>
